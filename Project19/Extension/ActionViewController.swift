...
class ActionViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.leftBarButtonItem = UIBarButtonItem(barButtonSystemItem: .add, target: self, action: #selector(chooseDefaultScript))
    ...
    @IBAction func chooseDefaultScript() {
        ...
        for key in defaultScripts.keys {
            ac.addAction(UIAlertAction(title: key, style: .default, handler: { _ in self.script.text = self.defaultScripts[key] }))
        }
