...
//  Project11
//
//  Created by Sergii Miroshnichenko on 18.06.2022.
//
...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    var countBalls = 5 {
        didSet {
            ballsCountLabel.text = "Balls: \(countBalls)"
        }
    }
    ...
    override func didMove(to view: SKView) {
        ...
        ballsCountLabel.position = CGPoint(x: 500, y: 700)
        ...
        if let touch = touches.first {
            ...
            if objects.contains(editLabel) {
                ...
                if editingMode {
                    ...
                    if countBalls > 0 {
                        let randomIndex = Int.random(in: 0..<balls.count)
                        let ball = SKSpriteNode(imageNamed: balls[randomIndex])
                        ...
                        alert.addAction(UIAlertAction(title: "OK", style: .cancel, handler: restartGame))
