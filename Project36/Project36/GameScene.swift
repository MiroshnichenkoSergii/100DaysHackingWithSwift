...
//  Project36
//
//  Created by Sergii Miroshnichenko on 29.08.2022.
//
...
//        bottomRock.physicsBody = SKPhysicsBody(texture: rockTexture, size: rockTexture.size())
        ...
        // 2 Create a third sprite that is a large red rectangle. This will be positioned just after the rocks and will be used to track when the player has passed through the rocks safely – if they touch that red rectangle, they should score a point.
